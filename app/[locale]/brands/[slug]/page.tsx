    ...
    <div className="container px-4 py-12 md:px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-12">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {brand.series.map((series, index) => (
                  <ProgressiveLoader key={series.id} delay={300 + index * 100}>
                    <Link
        ...
        {hasModelsWithoutSeries && (
          <ProgressiveLoader delay={brand.series && brand.series.length > 0 ? 400 : 200}>
            <div>
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {modelsWithoutSeries.map((model, index) => (
                  <ProgressiveLoader key={model.id} delay={500 + index * 50}>
                    <Link
