...
export function BrandsSectionLazy() {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        ...
        // Додаємо невелику затримку для демонстрації ліниво завантаження
    ...
    // Використовуємо Intersection Observer для завантаження тільки коли секція видима
  ...
  return (
    <section id="brands-section" className="py-12 bg-gray-50">
