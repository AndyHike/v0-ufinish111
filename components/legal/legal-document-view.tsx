...
/**
 * Shared renderer for legal pages (privacy / terms / generic /legal/[slug]).
 * Centralises the markdown styling that was previously duplicated across the
 * privacy and terms page components.
 */
export function LegalDocumentView({ title, content, emptyText }: LegalDocumentViewProps) {
  return (
